...
/**
 * Get get the users current choices
 *
 *
 * @return array
 */
        ...
        {
            return array_values(R::find('choice', 'user_id=?', [$this->bean->getID()]));
        }
...
/**
  * Counts the number of students a given supervisor is supervising?
  *
  * @param string   $userid
  *
  * @return int
  */
        public function issupervising()
        {
            return R::count('finalchoice', 'supervisor_id = ?', [$this->bean->getID()]);
        }
/**
 ...
 */
        ...
        {
            return is_object($this->hasrole('Module', 'Leader'));
        }
/**
 ...
 */
        ...
        {
            return is_object($this->hasrole('Theme', 'Leader'));
        }
/**
 ...
 */
        ...
        {
            if (is_object($this->hasrole('Theme', 'Leader')))
            {
                return true;
            }
            if (is_object($this->hasrole('Module', 'Leader')))
            {
                return true;
            }
            if (is_object($this->hasrole('Project', 'supervisor')))
            {
                return true;
            }
            return false;
...
/**
 * Is this user a project supervisor?
 *
 * @return boolean
 */
...
/**
 * Is this user a project student?
 *
 * @return boolean
 */
